angular.module('template/treeGrid/treeGrid.html', []).run([
    '$templateCache',
...
angular.module('treeGrid', [
        ...
        }]).directive('treeGrid', ['$timeout', 'treegridTemplate', function ($timeout, treegridTemplate) {
            return {
                restrict: 'E',
                ...
                link: function (scope, element, attrs) {
                    ...
                    scope.on_user_clickdelete = function (branch) {
                        if (scope.onClickdelete) {
                            var partent=get_parent(branch);
                            return scope.onClickdelete({
                                branch: branch,
                                parent:partent
                            });
                        }
